...
function NancyA() {
    ...
    return (
        <div>
            ...
            <div>
                <div
                    className="flex flex-col items-center justify-center pt-44 lg:pt-24 h-full bg-cover bg-center  "
                    style={{ backgroundImage: "url(nncy.jpg" }}>

                    <div className="top-[4rem] text-center mb-8">
                        <h1 className="text-xl md:text-4xl text-white font-bold w-60 lg:w-fit">Cek Kondisi Kesehatan Keuangan Anda</h1>
                    </div>

                    <div className=" px-12 py-10 rounded-2xl bg-white/30 backdrop-blur-lg shadow-lg h-[730px] md:h-[456px]">
                        <form onSubmit={submitHandle}>
                            ...
                            <div className=" flex flex-col md:flex-row items-center justify-center">
                                ...
                                <div className="pr-0 md:pr-6">
                                    <div className="mb-3">
                                        <p className="text-xl font-semibold text-white">Pendapatan</p>
                                    </div>

                                    <label className="block text-white">Pendapatan utama</label>
                                    <input
                                        type="text"
                                        name="mainIncome"
                                        value={income.mainIncome}
                                        onChange={incomeChange}
                                        className="p-2 border rounded-md mt-1 bg-transparent text-white" />

                                    <label className="block mt-3 text-white">Pendapatan sampingan</label>
                                    <input
                                        type="text"
                                        name="sideIncome"
                                    ...
                                    <label className="block mt-3 text-white">Investasi</label>
                                    <input
                                        type="text"
                                        name="passiveIncome"
                                ...
                                <div className="pl-0 md:pl-6 mt-6 md:mt-0">
                                    <div className="mb-3">
                                        <p className="text-xl font-semibold text-white">Pengeluaran</p>
                                    </div>

                                    <label className="block text-white">Kebutuhan</label>
                                    <input
                                        type="text"
                                        name="kebutuhan"
                                    ...
                                    <label className="block mt-3 text-white">Keinginan</label>
                                    <input
                                        type="text"
                                        name="keinginan"
                                    ...
                                    <label className="block mt-3 text-white">Hutang/Cicilan</label>
                                    <input
                                        type="text"
                                        name="hutang"
